...
//    Board 에서 내용 지울때 image file도 같이 file 테이블에서 지우기 위해 부르는 메서드
    ...
    void deleteByTableIdAndCategoryAndUserId(Integer wordbookId, FilesEntity.Category category, String userId);
    // [ 단어 추가시 파일 존재 여부 확인 ]
    FilesEntity findByUserIdAndTableIdAndCategory(String userId, Integer tableId, FilesEntity.Category category);
